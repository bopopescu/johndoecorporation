...
class TestViews(TestBase):
    ...
    def test_admin_dashboard_view(self):
        """
        Test that admin dashboard is inaccessible without login and redirects to login page then to dashboard
        """
    ...
    def test_department_view(self):
        """
        Test that department page is inaccessible without login and redirects to login page then to dashboard
        """
    ...
    def test_roles_view(self):
        """
        Test that roles page is inaccessible without login and redirects to login page then to dashboard
        """
    ...
    def test_employees_view(self):
        """
        Test that employees page is inaccessible without login and redirects to login page then to dashboard
        """
